 ...
 */
class PluginConfigurationArchiveInstance extends InstanceResource
{
    /**
     ...
     */
    protected function proxy(): PluginConfigurationArchiveContext
    {
        if (!$this->context) {
            $this->context = new PluginConfigurationArchiveContext(
                $this->version,
                $this->solution['sid']
            );
        }
