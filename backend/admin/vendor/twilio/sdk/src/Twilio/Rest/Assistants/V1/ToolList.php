...
class ToolList extends ListResource
    ...
    /**
     * Reads ToolInstance records from the API as a list.
     ...
     * @return ToolInstance[] Array of results
     */
     ...
     * @return ToolPage Page of ToolInstance
     */
    ...
    ): ToolPage
    {
        ...
        return new ToolPage($this->version, $response, $this->solution);
    }
     ...
     * @return ToolPage Page of ToolInstance
     */
    public function getPage(string $targetUrl): ToolPage
    {
