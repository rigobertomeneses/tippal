...
class Google_Service_Sheets_RefreshDataSourceResponse extends Google_Collection
{
  protected $collection_key = 'statuses';
  protected $statusesType = 'Google_Service_Sheets_RefreshDataSourceObjectExecutionStatus';
