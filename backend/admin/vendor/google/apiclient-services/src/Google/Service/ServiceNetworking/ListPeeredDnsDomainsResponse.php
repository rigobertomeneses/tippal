...
class Google_Service_ServiceNetworking_ListPeeredDnsDomainsResponse extends Google_Collection
{
  protected $collection_key = 'peeredDnsDomains';
  protected $peeredDnsDomainsType = 'Google_Service_ServiceNetworking_PeeredDnsDomain';
