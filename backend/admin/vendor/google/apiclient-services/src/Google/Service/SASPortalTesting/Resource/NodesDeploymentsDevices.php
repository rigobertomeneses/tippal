 ...
 *  </code>
 */
class Google_Service_SASPortalTesting_Resource_NodesDeploymentsDevices extends Google_Service_Resource
{
  /**
   ...
   */
  public function listNodesDeploymentsDevices($parent, $optParams = array())
  {
