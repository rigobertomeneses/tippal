 ...
 *  </code>
 */
class Google_Service_SearchConsole_Resource_Sitemaps extends Google_Service_Resource
{
  /**
  ...
  public function get($siteUrl, $feedpath, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_SearchConsole_WmxSitemap");
  }
  /**
   ...
   * @return Google_Service_SearchConsole_SitemapsListResponse
   */
  public function listSitemaps($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_SearchConsole_SitemapsListResponse");
  }
  /**
