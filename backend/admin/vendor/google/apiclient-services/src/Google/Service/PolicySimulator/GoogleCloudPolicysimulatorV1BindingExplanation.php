...
class Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1BindingExplanation extends Google_Model
{
  public $access;
  protected $conditionType = 'Google_Service_PolicySimulator_GoogleTypeExpr';
  protected $conditionDataType = '';
  protected $membershipsType = 'Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership';
  ...
  /**
   * @param Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership[]
   */
  ...
  /**
   * @return Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership[]
   */
