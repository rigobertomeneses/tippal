...
class Google_Service_OSConfig_PatchInstanceFilter extends Google_Collection
{
  protected $collection_key = 'zones';
  public $all;
  protected $groupLabelsType = 'Google_Service_OSConfig_PatchInstanceFilterGroupLabel';
