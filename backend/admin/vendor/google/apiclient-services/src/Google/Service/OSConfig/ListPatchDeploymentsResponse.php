...
class Google_Service_OSConfig_ListPatchDeploymentsResponse extends Google_Collection
{
  protected $collection_key = 'patchDeployments';
  public $nextPageToken;
  protected $patchDeploymentsType = 'Google_Service_OSConfig_PatchDeployment';
