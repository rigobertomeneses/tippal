...
class Google_Service_ShoppingContent_RegionPostalCodeArea extends Google_Collection
{
  protected $collection_key = 'postalCodes';
  protected $postalCodesType = 'Google_Service_ShoppingContent_RegionPostalCodeAreaPostalCodeRange';
