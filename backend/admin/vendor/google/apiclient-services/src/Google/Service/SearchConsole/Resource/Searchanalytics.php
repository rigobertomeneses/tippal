 ...
 *  </code>
 */
class Google_Service_SearchConsole_Resource_Searchanalytics extends Google_Service_Resource
{
  /**
   ...
   * @param Google_Service_SearchConsole_SearchAnalyticsQueryRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_SearchConsole_SearchAnalyticsQueryResponse
   */
  public function query($siteUrl, Google_Service_SearchConsole_SearchAnalyticsQueryRequest $postBody, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Google_Service_SearchConsole_SearchAnalyticsQueryResponse");
  }
}
