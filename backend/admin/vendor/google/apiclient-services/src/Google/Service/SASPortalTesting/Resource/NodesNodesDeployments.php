 ...
 *  </code>
 */
class Google_Service_SASPortalTesting_Resource_NodesNodesDeployments extends Google_Service_Resource
{
  /**
   ...
   */
  public function listNodesNodesDeployments($parent, $optParams = array())
  {
