 ...
 *  </code>
 */
class Google_Service_OrgPolicyAPI_Resource_ProjectsPolicies extends Google_Service_Resource
{
  /**
   ...
   */
  public function listProjectsPolicies($parent, $optParams = array())
  {
