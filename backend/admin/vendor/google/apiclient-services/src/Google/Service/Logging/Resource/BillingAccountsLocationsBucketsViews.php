 ...
 *  </code>
 */
class Google_Service_Logging_Resource_BillingAccountsLocationsBucketsViews extends Google_Service_Resource
{
  /**
   ...
   */
  public function listBillingAccountsLocationsBucketsViews($parent, $optParams = array())
  {
