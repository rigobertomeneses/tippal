 ...
 *  </code>
 */
class Google_Service_OrgPolicyAPI_Resource_OrganizationsConstraints extends Google_Service_Resource
{
  /**
   ...
   */
  public function listOrganizationsConstraints($parent, $optParams = array())
  {
