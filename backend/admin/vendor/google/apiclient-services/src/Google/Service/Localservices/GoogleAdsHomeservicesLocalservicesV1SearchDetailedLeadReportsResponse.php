...
class Google_Service_Localservices_GoogleAdsHomeservicesLocalservicesV1SearchDetailedLeadReportsResponse extends Google_Collection
{
  protected $collection_key = 'detailedLeadReports';
  protected $detailedLeadReportsType = 'Google_Service_Localservices_GoogleAdsHomeservicesLocalservicesV1DetailedLeadReport';
