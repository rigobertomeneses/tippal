...
class Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2NodeProperties extends Google_Collection
{
  protected $collection_key = 'properties';
  public $mtime;
  protected $propertiesType = 'Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2NodeProperty';
