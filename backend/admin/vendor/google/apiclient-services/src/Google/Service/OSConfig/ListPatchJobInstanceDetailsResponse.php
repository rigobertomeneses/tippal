...
class Google_Service_OSConfig_ListPatchJobInstanceDetailsResponse extends Google_Collection
{
  protected $collection_key = 'patchJobInstanceDetails';
  public $nextPageToken;
  protected $patchJobInstanceDetailsType = 'Google_Service_OSConfig_PatchJobInstanceDetails';
