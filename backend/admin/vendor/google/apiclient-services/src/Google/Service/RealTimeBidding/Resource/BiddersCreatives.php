 ...
 *  </code>
 */
class Google_Service_RealTimeBidding_Resource_BiddersCreatives extends Google_Service_Resource
{
  /**
   ...
   */
  public function watch($parent, Google_Service_RealTimeBidding_WatchCreativesRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Google_Service_RealTimeBidding_WatchCreativesResponse");
  }
}
