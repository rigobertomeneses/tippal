 ...
 *   $privateRanges = $networkconnectivityService->privateRanges;
 *  </code>
 */
class Google_Service_Networkconnectivity_Resource_ProjectsLocationsPrivateRanges extends Google_Service_Resource
{
  /**
   * Gets the access control policy for a resource. Returns an empty policy if the
   * resource exists and does not have a policy set. (privateRanges.getIamPolicy)
   *
   ...
   * `PERMISSION_DENIED` errors. (privateRanges.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which the policy is being
   ...
   * (privateRanges.testIamPermissions)
   *
