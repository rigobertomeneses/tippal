...
class Google_Service_ShoppingContent_RepricingRuleEffectiveTime extends Google_Collection
{
  protected $collection_key = 'fixedTimePeriods';
  protected $fixedTimePeriodsType = 'Google_Service_ShoppingContent_RepricingRuleEffectiveTimeFixedTimePeriod';
