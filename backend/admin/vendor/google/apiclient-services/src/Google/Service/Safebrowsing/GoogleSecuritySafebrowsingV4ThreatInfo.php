...
class Google_Service_Safebrowsing_GoogleSecuritySafebrowsingV4ThreatInfo extends Google_Collection
{
  protected $collection_key = 'threatTypes';
  public $platformTypes;
  protected $threatEntriesType = 'Google_Service_Safebrowsing_GoogleSecuritySafebrowsingV4ThreatEntry';
