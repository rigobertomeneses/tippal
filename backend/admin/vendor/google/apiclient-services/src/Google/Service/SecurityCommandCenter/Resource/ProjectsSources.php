 ...
 *  </code>
 */
class Google_Service_SecurityCommandCenter_Resource_ProjectsSources extends Google_Service_Resource
{
  /**
   ...
   */
  public function listProjectsSources($parent, $optParams = array())
  {
