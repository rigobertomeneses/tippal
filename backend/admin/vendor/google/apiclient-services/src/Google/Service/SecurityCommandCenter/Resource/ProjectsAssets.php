 ...
 *  </code>
 */
class Google_Service_SecurityCommandCenter_Resource_ProjectsAssets extends Google_Service_Resource
{
  /**
   ...
   */
  public function listProjectsAssets($parent, $optParams = array())
  {
