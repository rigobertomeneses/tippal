...
class Google_Service_Sheets_DataSourceSheetDimensionRange extends Google_Collection
{
  protected $collection_key = 'columnReferences';
  protected $columnReferencesType = 'Google_Service_Sheets_DataSourceColumnReference';
