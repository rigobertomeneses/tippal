 ...
 *  </code>
 */
class Google_Service_ShoppingContent_Resource_Csses extends Google_Service_Resource
{
  /**
   ...
   */
  public function get($cssGroupId, $cssDomainId, $optParams = array())
  {
    $params = array('cssGroupId' => $cssGroupId, 'cssDomainId' => $cssDomainId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_ShoppingContent_Css");
  }
  /**
  ...
  {
    $params = array('cssGroupId' => $cssGroupId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_ShoppingContent_ListCssesResponse");
  }
  /**
   ...
   * @return Google_Service_ShoppingContent_Css
   */
  public function updatelabels($cssGroupId, $cssDomainId, Google_Service_ShoppingContent_LabelIds $postBody, $optParams = array())
  {
    $params = array('cssGroupId' => $cssGroupId, 'cssDomainId' => $cssDomainId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('updatelabels', array($params), "Google_Service_ShoppingContent_Css");
  }
}
