...
class Google_Service_ShoppingContent_Collection extends Google_Collection
{
  ...
  public $customLabel3;
  public $customLabel4;
  protected $featuredProductType = 'Google_Service_ShoppingContent_CollectionFeaturedProduct';
  ...
  /**
   * @param Google_Service_ShoppingContent_CollectionFeaturedProduct[]
   */
  ...
  /**
   * @return Google_Service_ShoppingContent_CollectionFeaturedProduct[]
   */
