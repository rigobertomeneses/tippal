...
class Google_Service_PeopleService_BatchUpdateContactsResponse extends Google_Model
{
  protected $updateResultType = 'Google_Service_PeopleService_PersonResponse';
