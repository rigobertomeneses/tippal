...
class Google_Service_MyBusinessAccountManagement_ListAccountAdminsResponse extends Google_Collection
{
  protected $collection_key = 'accountAdmins';
  protected $accountAdminsType = 'Google_Service_MyBusinessAccountManagement_Admin';
  protected $accountAdminsDataType = 'array';

  /**
   * @param Google_Service_MyBusinessAccountManagement_Admin[]
   */
