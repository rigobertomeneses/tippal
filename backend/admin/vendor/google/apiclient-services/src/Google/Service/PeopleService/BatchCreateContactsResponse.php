...
class Google_Service_PeopleService_BatchCreateContactsResponse extends Google_Collection
{
  protected $collection_key = 'createdPeople';
  protected $createdPeopleType = 'Google_Service_PeopleService_PersonResponse';
