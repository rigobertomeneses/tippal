 ...
 *  </code>
 */
class Google_Service_OrgPolicyAPI_Resource_OrganizationsPolicies extends Google_Service_Resource
{
  /**
   ...
   */
  public function listOrganizationsPolicies($parent, $optParams = array())
  {
