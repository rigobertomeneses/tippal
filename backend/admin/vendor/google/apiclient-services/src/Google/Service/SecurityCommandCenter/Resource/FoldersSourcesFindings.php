 ...
 *  </code>
 */
class Google_Service_SecurityCommandCenter_Resource_FoldersSourcesFindings extends Google_Service_Resource
{
  /**
   ...
   */
  public function listFoldersSourcesFindings($parent, $optParams = array())
  {
