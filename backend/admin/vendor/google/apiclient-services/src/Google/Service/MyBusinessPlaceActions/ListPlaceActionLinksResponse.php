...
class Google_Service_MyBusinessPlaceActions_ListPlaceActionLinksResponse extends Google_Collection
{
  protected $collection_key = 'placeActionLinks';
  public $nextPageToken;
  protected $placeActionLinksType = 'Google_Service_MyBusinessPlaceActions_PlaceActionLink';
  ...
  /**
   * @param Google_Service_MyBusinessPlaceActions_PlaceActionLink[]
   */
