...
class Google_Service_SmartDeviceManagement_GoogleHomeEnterpriseSdmV1ListStructuresResponse extends Google_Collection
{
  protected $collection_key = 'structures';
  public $nextPageToken;
  protected $structuresType = 'Google_Service_SmartDeviceManagement_GoogleHomeEnterpriseSdmV1Structure';
