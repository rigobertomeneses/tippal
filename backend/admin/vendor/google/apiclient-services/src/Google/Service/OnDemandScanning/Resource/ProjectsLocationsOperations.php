 ...
 *  </code>
 */
class Google_Service_OnDemandScanning_Resource_ProjectsLocationsOperations extends Google_Service_Resource
{
  /**
   ...
   * @return Google_Service_OnDemandScanning_OndemandscanningEmpty
   */
  public function cancel($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Google_Service_OnDemandScanning_OndemandscanningEmpty");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_OnDemandScanning_OndemandscanningEmpty");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_OnDemandScanning_Operation");
  }
  /**
   ...
   * @return Google_Service_OnDemandScanning_ListOperationsResponse
   */
  public function listProjectsLocationsOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_OnDemandScanning_ListOperationsResponse");
  }
  /**
   ...
   * @return Google_Service_OnDemandScanning_Operation
   */
  public function wait($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('wait', array($params), "Google_Service_OnDemandScanning_Operation");
  }
}
