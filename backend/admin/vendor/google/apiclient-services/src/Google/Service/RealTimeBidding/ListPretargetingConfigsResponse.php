...
class Google_Service_RealTimeBidding_ListPretargetingConfigsResponse extends Google_Collection
{
  protected $collection_key = 'pretargetingConfigs';
  public $nextPageToken;
  protected $pretargetingConfigsType = 'Google_Service_RealTimeBidding_PretargetingConfig';
