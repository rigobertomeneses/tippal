 ...
 *  </code>
 */
class Google_Service_Logging_Resource_FoldersLocationsBucketsViews extends Google_Service_Resource
{
  /**
   ...
   */
  public function listFoldersLocationsBucketsViews($parent, $optParams = array())
  {
