 ...
 *  </code>
 */
class Google_Service_Logging_Resource_ProjectsLocationsBucketsViews extends Google_Service_Resource
{
  /**
  ...
  /**
   * Lists views on a bucket. (views.listProjectsLocationsBucketsViews)
   *
   ...
   */
  public function listProjectsLocationsBucketsViews($parent, $optParams = array())
  {
