 ...
 *  </code>
 */
class Google_Service_PolicySimulator_Resource_Operations extends Google_Service_Resource
{
  /**
  ...
  public function get($name, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_PolicySimulator_GoogleLongrunningOperation");
  }
  /**
   ...
   * @return Google_Service_PolicySimulator_GoogleLongrunningListOperationsResponse
   */
  public function listOperations($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_PolicySimulator_GoogleLongrunningListOperationsResponse");
  }
}
