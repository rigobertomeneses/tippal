...
class Google_Service_ShoppingContent_ListAccountReturnCarrierResponse extends Google_Collection
{
  protected $collection_key = 'accountReturnCarriers';
  protected $accountReturnCarriersType = 'Google_Service_ShoppingContent_AccountReturnCarrier';
  protected $accountReturnCarriersDataType = 'array';

  /**
   * @param Google_Service_ShoppingContent_AccountReturnCarrier[]
   */
