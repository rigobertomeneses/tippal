...
class Google_Service_ShoppingContent_ListReturnPolicyOnlineResponse extends Google_Collection
{
  protected $collection_key = 'returnPolicies';
  protected $returnPoliciesType = 'Google_Service_ShoppingContent_ReturnPolicyOnline';
  protected $returnPoliciesDataType = 'array';

  /**
   * @param Google_Service_ShoppingContent_ReturnPolicyOnline[]
   */
