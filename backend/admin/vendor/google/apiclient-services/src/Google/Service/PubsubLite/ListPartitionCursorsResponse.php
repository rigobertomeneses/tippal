...
class Google_Service_PubsubLite_ListPartitionCursorsResponse extends Google_Collection
{
  protected $collection_key = 'partitionCursors';
  public $nextPageToken;
  protected $partitionCursorsType = 'Google_Service_PubsubLite_PartitionCursor';
