...
class Google_Service_SmartDeviceManagement_GoogleHomeEnterpriseSdmV1ListRoomsResponse extends Google_Collection
{
  protected $collection_key = 'rooms';
  public $nextPageToken;
  protected $roomsType = 'Google_Service_SmartDeviceManagement_GoogleHomeEnterpriseSdmV1Room';
