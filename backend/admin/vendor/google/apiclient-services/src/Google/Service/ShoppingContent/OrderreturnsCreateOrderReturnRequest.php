...
class Google_Service_ShoppingContent_OrderreturnsCreateOrderReturnRequest extends Google_Collection
{
  protected $collection_key = 'lineItems';
  protected $lineItemsType = 'Google_Service_ShoppingContent_OrderreturnsLineItem';
