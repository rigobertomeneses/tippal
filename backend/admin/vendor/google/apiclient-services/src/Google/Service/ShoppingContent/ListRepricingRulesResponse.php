...
class Google_Service_ShoppingContent_ListRepricingRulesResponse extends Google_Collection
{
  protected $collection_key = 'repricingRules';
  public $nextPageToken;
  protected $repricingRulesType = 'Google_Service_ShoppingContent_RepricingRule';
