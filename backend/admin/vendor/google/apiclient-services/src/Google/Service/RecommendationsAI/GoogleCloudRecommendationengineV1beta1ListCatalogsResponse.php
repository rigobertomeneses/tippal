...
class Google_Service_RecommendationsAI_GoogleCloudRecommendationengineV1beta1ListCatalogsResponse extends Google_Collection
{
  protected $collection_key = 'catalogs';
  protected $catalogsType = 'Google_Service_RecommendationsAI_GoogleCloudRecommendationengineV1beta1Catalog';
