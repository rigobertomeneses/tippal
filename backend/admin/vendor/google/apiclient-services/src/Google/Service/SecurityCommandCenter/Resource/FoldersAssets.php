 ...
 *  </code>
 */
class Google_Service_SecurityCommandCenter_Resource_FoldersAssets extends Google_Service_Resource
{
  /**
   ...
   */
  public function listFoldersAssets($parent, $optParams = array())
  {
