 ...
 *  </code>
 */
class Google_Service_RecommendationsAI_Resource_ProjectsLocationsCatalogsEventStoresOperations extends Google_Service_Resource
{
  /**
  ...
  public function get($name, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_RecommendationsAI_GoogleLongrunningOperation");
  }
  /**
   ...
   */
  public function listProjectsLocationsCatalogsEventStoresOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_RecommendationsAI_GoogleLongrunningListOperationsResponse");
  }
}
