...
class Google_Service_ShoppingContent_ListAccountLabelsResponse extends Google_Collection
{
  protected $collection_key = 'accountLabels';
  protected $accountLabelsType = 'Google_Service_ShoppingContent_AccountLabel';
