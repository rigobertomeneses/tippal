 ...
 *  </code>
 */
class Google_Service_OSConfig_Resource_Operations extends Google_Service_Resource
{
  /**
   ...
   * @return Google_Service_OSConfig_ListOperationsResponse
   */
  public function listOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_OSConfig_ListOperationsResponse");
  }
}
