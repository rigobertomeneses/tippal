...
class Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1ExplainedPolicy extends Google_Collection
{
  protected $collection_key = 'bindingExplanations';
  public $access;
  protected $bindingExplanationsType = 'Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1BindingExplanation';
  ...
  /**
   * @param Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1BindingExplanation[]
   */
  ...
  /**
   * @return Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1BindingExplanation[]
   */
