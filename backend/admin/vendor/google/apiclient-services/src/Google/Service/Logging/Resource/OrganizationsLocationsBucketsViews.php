 ...
 *  </code>
 */
class Google_Service_Logging_Resource_OrganizationsLocationsBucketsViews extends Google_Service_Resource
{
  /**
  ...
  /**
   * Lists views on a bucket. (views.listOrganizationsLocationsBucketsViews)
   *
   ...
   */
  public function listOrganizationsLocationsBucketsViews($parent, $optParams = array())
  {
